...
lw $t0, 12($t1)  # put the value at the memory address of
                 # fibs[3] array, which is 4 bytes away from
                 # the address that the label fibs aliases,
                 # into the register
                 
lw $t0, 24($t1)  # put the value at the memory address of
                 # fibs[6] array, which is 4 bytes away from
                 # the address that the label fibs aliases,
                 # into the register 